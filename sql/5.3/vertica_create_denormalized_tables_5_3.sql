...
select t.*, tt.array_atc5_concept_codes, tt.atc5_concept_codes from (
    ...
    from
         (select drug_concept_id, atc5_concept_code, atc5_concept_name,
                 atc5_concept_code || '|' ||  atc5_concept_name as atc5_concept_codes_with_description
                 from map2_atc5_concepts
         order by drug_concept_id, atc5_concept_code) a5t
   ...
   join (
    ...
    on tt.drug_concept_id = t.drug_concept_id
order by tt.atc5_concept_codes
;
...
select d0.drug_concept_id, d0.drug_concept_code, d0.drug_concept_name, ingredient_concept_names,
       ingredient_concept_codes, ingredient_concept_ids
from
     drug_ingredients d0
     join
    ...
    join (
        ...
        from drug_ingredients group by drug_concept_id) d3 on d0.drug_concept_id = d3.drug_concept_id
;
